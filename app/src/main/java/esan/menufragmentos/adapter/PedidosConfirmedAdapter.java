...
public class PedidosConfirmedAdapter extends RecyclerView.Adapter<PedidosConfirmedAdapter.ViewHolder> {
    ...
    private ArrayList<PedidosConfirmed> pedidosConfirmed;
    public PedidosConfirmedAdapter(ArrayList<PedidosConfirmed> pedidos) {
        this.pedidosConfirmed = pedidos;
    }
    ...
    @Override public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        PedidosConfirmed item = pedidosConfirmed.get(position);
        ...
        holder.btnVerPedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                VerPedidoConfirmed fragment = new VerPedidoConfirmed();
