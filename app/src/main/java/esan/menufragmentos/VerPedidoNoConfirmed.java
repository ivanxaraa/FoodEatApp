...
public class VerPedidoNoConfirmed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.verpedido_noconfirmed, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        //recusarPedido
        String url4 = URLS.URL_PEDIDOS + "?op=recusarPedido&idPedido=" + idPedido;
