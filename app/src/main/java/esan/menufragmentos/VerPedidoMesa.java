...
public class VerPedidoMesa extends Fragment {
    ...
    Button btnEntrege, btnAceitar, btnRecusar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.verpedido_mesa, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnEntrege.setVisibility(View.GONE);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                String numeroMesa = c.getString("numero");
                                String idMesa = c.getString("idMesa");
                                textTable.setText(getContext().getResources().getString(R.string.Mesa) + " " + numeroMesa);
                                if(c.getString("username") != "null") {
                                    textNomeCliente.setText(c.getString("username"));
                                }else{
                                    rowUser.setVisibility(view.INVISIBLE);
                                }
                                String estadoMesa = c.getString("estado");
                                ...
                                voltarText.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        bundle.putInt("idMesa", Integer.valueOf(idMesa));
                                        bundle.putInt("numeroMesa", Integer.valueOf(numeroMesa));
                                ...
                                switch(estadoMesa){
                                    ...
                                    case  "Confirmado":
                                        container.setVisibility(View.VISIBLE);
                                        btnEntrege.setVisibility(View.VISIBLE);
                                        break;
                                    case  "Entregue":
                                        container.setVisibility(View.GONE);
                                        break;
        ...
        //aceitarPedido
        String url3 = URLS.URL_PEDIDOS + "?op=aceitarPedido&idPedido=" + idPedido;
        btnAceitar = view.findViewById(R.id.btnAceitar);
        ...
        //recusarPedido
        String url5 = URLS.URL_PEDIDOS + "?op=recusarPedido&idPedido=" + idPedido;
        btnRecusar = view.findViewById(R.id.btnRecusar);
